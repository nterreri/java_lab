...
public class MouseListening extends JFrame {
	...
	/**
	 * Static method called by MouseListener instance, updates the coordinates
	 * of the JComponent firing the event caught by the listener.
	 * @param componentFiring
	 * @param x
	 * @param y
	 */
	static void update_coords(JComponent componentFiring, int x, int y) {
		//New coordinates have to be adjusted by current JComponent position:
		//the ones passed to the function refer to absolute position on frame.
